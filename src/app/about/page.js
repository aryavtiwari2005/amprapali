  ...
  return (
    <div className="w-full bg-white">
      <div className="relative h-screen overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-yellow-300 to-transparent opacity-85" />
        ...
        <div className="absolute inset-0 flex flex-col items-start justify-center px-8 md:px-16 lg:px-24">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-7xl font-light text-brown-800 mb-8 leading-tight tracking-tight">
              Building <span className="font-bold block">Dreams & Legacies</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-700 mb-12 leading-relaxed font-light tracking-wide">
            ...
            <button className="bg-yellow-400 hover:bg-yellow-500 text-white px-10 py-5 rounded-lg flex items-center text-lg transition-all duration-300 transform hover:translate-x-2 font-medium tracking-wide">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center p-8 border-r last:border-r-0 border-gray-100">
                <h3 className="text-4xl md:text-5xl font-light text-brown-800 mb-3">{stat.value}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          <div className="space-y-10">
            <h2 className="text-5xl font-light leading-tight">
              <span className="text-brown-800 font-medium">AMRAPALI GROUP</span>
              <br />
            ...
            <div className="bg-yellow-100 p-10 rounded-xl shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="flex items-start space-x-4">
                  <Building2 className="w-5 h-5 mt-1 text-yellow-400 flex-shrink-0" />
                  <span className="font-light">{contactInfo.corporate.address}</span>
                </p>
                <p className="flex items-center space-x-4">
                  <Phone className="w-5 h-5 text-yellow-400 flex-shrink-0" />
                  <a href={`tel:${contactInfo.corporate.phone}`} className="hover:text-yellow-400 transition-colors duration-200 font-light">
                    {contactInfo.corporate.phone}
                  </a>
                </p>
                <p className="flex items-center space-x-4">
                  <Mail className="w-5 h-5 text-yellow-400 flex-shrink-0" />
                  <a href={`mailto:${contactInfo.corporate.email}`} className="hover:text-yellow-400 transition-colors duration-200 font-light">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="flex items-center space-x-4">
                  <Phone className="w-5 h-5 text-yellow-400 flex-shrink-0" />
                  <a href={`tel:${contactInfo.registered.phone}`} className="hover:text-yellow-400 transition-colors duration-200 font-light">
                    {contactInfo.registered.phone}
                  </a>
                </p>
                <p className="flex items-center space-x-4">
                  <Mail className="w-5 h-5 text-yellow-400 flex-shrink-0" />
                  <a href={`mailto:${contactInfo.registered.email}`} className="hover:text-yellow-400 transition-colors duration-200 font-light">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <a href="#" className="flex items-center space-x-3 hover:text-yellow-400 transition-colors duration-200">
              ...
              <div className="pt-8 space-y-4">
                ...
                <div className="flex space-x-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 rounded-lg bg-yellow-200 border border-yellow-300 text-gray-800 placeholder-gray-400 focus:outline-none focus:border-yellow-500"
                  />
                  <button className="px-6 py-2 bg-yellow-400 hover:bg-yellow-500 rounded-lg transition-colors duration-200">
                    Subscribe
                  </button>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex space-x-6">
                <a href="#" className="text-gray-300 hover:text-yellow-400 transition-colors duration-200 font-light">Privacy Policy</a>
                <a href="#" className="text-gray-300 hover:text-yellow-400 transition-colors duration-200 font-light">Terms of Service</a>
                <a href="#" className="text-gray-300 hover:text-yellow-400 transition-colors duration-200 font-light">Cookie Policy</a>
              </div>
            </div>
          </div>
        </div>
